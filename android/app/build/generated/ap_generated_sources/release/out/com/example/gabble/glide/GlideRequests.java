package com.example.gabble.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.gabble.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.gabble.glide.GlideOptions().apply(toSet));
    }
  }
}
