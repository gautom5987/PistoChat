...
public final class ItemContainerStoryBinding implements ViewBinding {
  @NonNull
  ...
  private ItemContainerStoryBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemContainerStoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemContainerStoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_container_story, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemContainerStoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContainerStoryBinding((ConstraintLayout) rootView, imageProfile, textDateTime,
