...
public final class ActivityUserBinding implements ViewBinding {
  ...
  private ActivityUserBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView textErrorMessage, @NonNull RecyclerView usersRecylerView) {
    this.rootView = rootView;
    this.imageBack = imageBack;
    this.progressBar = progressBar;
    this.textErrorMessage = textErrorMessage;
    this.usersRecylerView = usersRecylerView;
  }
  ...
  public static ActivityUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.usersRecylerView;
      RecyclerView usersRecylerView = ViewBindings.findChildViewById(rootView, id);
      if (usersRecylerView == null) {
        break missingId;
      }

      return new ActivityUserBinding((ConstraintLayout) rootView, imageBack, progressBar,
          textErrorMessage, usersRecylerView);
    }
