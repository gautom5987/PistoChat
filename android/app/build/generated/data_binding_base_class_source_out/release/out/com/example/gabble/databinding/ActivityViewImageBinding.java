...
public final class ActivityViewImageBinding implements ViewBinding {
  ...
  private ActivityViewImageBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageContent) {
  ...
  public static ActivityViewImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityViewImageBinding((ConstraintLayout) rootView, imageContent);
    }
