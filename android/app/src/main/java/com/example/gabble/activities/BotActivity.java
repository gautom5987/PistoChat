...
import com.example.gabble.databinding.ActivityBotBinding;
...
//            Log.d(Constants.TAG, "loadReceiverDetails: "+mobile);
...
//            Log.d(Constants.TAG, "loadReceiverDetails: "+getUserInformation.getName());
//            receiverUser.image = getUserInformation.getImage();
//            receiverUser.about = getUserInformation.getAbout();
            receiverUser.phoneNo = mobile;
            loadData(mobile);
        }

        Log.d(Constants.TAG, "loadReceiverDetails: "+receiverUser.name);
    }

    private void loadData(String mobileNo) {
        ...
        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                receiverUser.name = documentSnapshot.getString(Constants.KEY_NAME);
                receiverUser.image = documentSnapshot.getString(Constants.KEY_IMAGE);
                receiverUser.about = documentSnapshot.getString(Constants.KEY_ABOUT);
                binding.textName.setText(receiverUser.name);
//                about = documentSnapshot.getString(Constants.KEY_ABOUT);
                Log.d(Constants.TAG, "onSuccess: "+ receiverUser.name);
            }
...
//        });
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        ...
                        break; // image
                    case 1:
                        Intent intent = new Intent(BotActivity.this,ContactsActivity.class);
                        intent.putExtra(Constants.KEY_USER,receiverUser);
                        startActivity(intent);
                        break; // contacts
                }
    ...
    private void addConversation(HashMap<String, Object> conversation) {
        ...
        obj.put("lastMessage",conversation.get(Constants.KEY_LAST_MESSAGE));
    ...
    private void listenAvailabilityOfUser() {
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).document(
                receiverUser.phoneNo
        ).addSnapshotListener(BotActivity.this, (value, error) -> {
            if(error!=null) {
                return;
            }
            if(value!=null) {
